      ...
      <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white">
            ...
            <div className="grid grid-cols-2 gap-5">
              <div className="flex items-center justify-betweeen p-5 gap-5 rounded-md shadow-md">
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-4xl font-bold">
                    {allPayments?.count || subscribeCount}
                  </h3>
                </div>
              ...
              <div className="flex items-center justify-betweeen p-5 gap-5 rounded-md shadow-md">
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-4xl font-bold">
                    {allPayments?.count || subscribeCount * 200}
                  </h3>
                </div>
        ...
        <div className="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10">
          <div className="flex w-full items-center justify-between">
            <h1 className="text-center text-3xl forn-semibold">
              All Appoitements
            </h1>
            <button
                ...
                return (
                  <tr key={course._id}>
                    ...
                    <td className="flex items-center gap-4">
                      <button
                        className="bg-green-500 hover:bg-green-600 transition-all ease-in-out duration-300 rounded-md text-xl py-2 px-4 font-bold"
                        onClick={() =>
                      ...
                      <button
                        className="bg-red-500 hover:bg-red-600 transition-all ease-in-out duration-300 rounded-md text-xl py-2 px-4 font-bold"
