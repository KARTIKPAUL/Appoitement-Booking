    ...
    <HomeLayout>
      <div className="flex items-center justify-center h-[100vh]">
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="eamil" className="font-semibold">
              {" "}
              Email{" "}
            </label>
            <input
          ...
          <button
            type="submit"
            className="w-full bg-yellow-500 hover:bg-yellow-600 translate-all ease-in-out duration-300 rounded py-2 font-semibold text-xl my-2"
          >
            Create Account
          </button>
