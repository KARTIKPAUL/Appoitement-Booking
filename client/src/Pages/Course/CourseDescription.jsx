      ...
      <div className="min-h-[90vh] pt-12 px-20 flex flex-col items-center justify-center text-white">
        <div className="grid grid-cols-2 gap-2 py-10 relative">
              ...
              <div className="flex flex-col items-center justify-between text-xl">
                ...
                data?.subscription?.status === "active" ? (
                  <button
                    ...
                    className="bg-yellow-500 text-xl rounded-md font-bold px-5 py-3 w-full hover:bg-yellow-600 transition-all ease-in-out duration-200 mt-5"
                  >
                    Watch Lectues
                  </button>
                ) : (
          ...
          <div className="space-y-2 font-xl">
            <h6 className="text-3xl font-bold text-yellow-600 mb-4 text-center">
               {state?.title}
            </h6>
            <p className="text-yellow-500">Issues :</p>
