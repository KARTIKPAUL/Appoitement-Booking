...
function ContactUs() {
  ...
  return (
    <HomeLayout>
      <div className="flex min-w-7xl flex-col md:flex-row bg-gray-900 text-white min-h-screen mx-20">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-start">
          ...
          <div className="flex items-center mb-6">
            <div className="bg-blue-800 p-4 rounded-md mr-4">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col items-center">
          ...
          {/* Consultation Button */}
          <button
            className="w-full bg-blue-500 hover:bg-blue-600 transition-colors py-3 rounded-md font-semibold mb-6"
          ...
          <form className="w-full">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 px-4 py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                id="name"
                name="name"
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                className="w-full bg-gray-800 border border-gray-700 px-4 py-3 rounded-md h-40 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
                id="message"
                name="message"
                onChange={handleInputChange}
